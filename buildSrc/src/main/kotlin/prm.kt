...
abstract class GeneratePrm : DefaultTask() {
    ...
    val output: RegularFileProperty
        get() = project.objects.fileProperty()
            .convention(project.layout.buildDirectory.file(
                project.provider { "generated/${prm.get().name}-prm.json" }
            ))
    ...
    fun generate() {
        ...
        println(implConfigurationName + dependencyDescriptors)
        ...
        println(repositories + project.name)
