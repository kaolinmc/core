...
//    }
//
//    val node = com.kaolinmc.minecraft.bootstrapper.loadMinecraft(
//        version,
//        SimpleMavenRepositorySettings.local(), // SimpleMavenRepositorySettings.default(url = "https://maven.kaolinmc.com/snapshots"),
//        path,
//        archiveGraph,
...
//                return SimpleMavenDescriptor.parseDescription("com.kaolinmc.minecraft:minecraft-provider-def:2.0.14-SNAPSHOT")!!
//            }
//        }
//    )().merge()
//
